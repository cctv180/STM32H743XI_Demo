...
/*
*********************************************************************************************************
*    函 数 名: lib_bcd2dec  BCD码转十进制
*    功能说明: 将BCD码转十进制。 比如 0x58 ==> 58
*    形    参: _bcd   ：输入的BCD不检查必须正确
*    返 回 值: 转换结果
*********************************************************************************************************
*/
...
/*
*********************************************************************************************************
*    函 数 名: lib_dec2bcd  十进制转BCD码
*    功能说明: 将十进制转BCD码。 比如 99 ==> 0x99
*    形    参: _dec   ：输入的DEC不检查自动截断
*    返 回 值: 转换结果
*********************************************************************************************************
*/
